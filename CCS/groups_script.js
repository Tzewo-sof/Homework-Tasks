const initialGroups = [
    { subject: "Database Systems", year: "1st Year", days: ["Tue"], time: "04:00 - 05:00", members: "Selam, Tom", organizer: "Selamawit" },
    { subject: "Data Structures", year: "4th Year", days: ["Mon", "Wed"], time: "09:00 - 10:10", members: "Hana, Mike", organizer: "Hana" },
    { subject: "Web Development", year: "3rd Year", days: ["Fri"], time: "02:00 - 04:00", members: "Tsion, Yosef", organizer: "Tsion" }
];
...
document.addEventListener("DOMContentLoaded", () => {
            ...
            card.innerHTML = `
                <div class="group-info">
                    ...
                    <div class="group-meta">
                        <span><i class="fas fa-graduation-cap"></i> ${group.year}</span>
                        <span><i class="far fa-calendar-alt"></i> ${group.days.join(", ")}</span>
                    </div>
    ...
    createForm.addEventListener('submit', (e) => {
        ...
        if(selectedDays.length === 0) { alert("Select a day!"); return; }
        ...
        initialGroups.unshift({
            ...
            days: selectedDays,
            time: "10:00 - 12:00",
            members: document.getElementById('members').value || "New Group",
