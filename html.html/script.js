    ...
    if(hamburger) {
        hamburger.addEventListener('click', () => {
            if (navLinks.style.display === "flex") {
                ...
                navLinks.style.background = "#0f0f10";
...
// Helper for "Request Mentorship" buttons
function contactMentor(mentorName) {
    ...
    if(messageField) {
        ...
        messageField.style.borderColor = '#38ef7d';
        setTimeout(() => messageField.style.borderColor = '#333', 2000);
    }
}